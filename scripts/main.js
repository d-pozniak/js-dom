...
const Plants = [
    ...
    },
    {
        ...
        description: 'Easy to grow and only requiring minimal care, tomatoes are one of the most commonly grown vegetables in the world. In the vegetable patch or in the garden, but also on a balcony or a terrace, this plant has the added advantage of being very decorative',
    },
    {
        id: '5',
        commonName: 'Ivy',
        ...
        img: 'img/ivy.png',
        description: 'The main appeal of ivy is in its reliable, hardy evergreen leafage. It’s a favorite to create a deep green backdrop against which other colorful plants can stand out. Grow ivy as an addition to an indoor living plant wall. Slow growth and thick leaves will ensure a lot of greenery!',
    },
    {
        id: '6',
        ...
        img: 'img/orchid.png',
        description: 'The growing and caring for a Cymbidium orchid is on par with the easiest of all orchids. Deep into winter is generally when its magnificent blooming is appreciated, with its bunches of bright colorful flowers. This is an easy plant to care for and it will decorate your home for months on end. Cymbidium orchid cherishes moisture, and needs to be watered often but without forgetting that the root area must stay clear of water or the roots will rot.',
    },
];

const Intro = {
    heading: 'Choose a plant that best suits you!',
    description:'Indoor plants are perfect items to welcome at home. They can purify the air, create a cozy atmosphere and help you relax after a long working day. Learn more about each popular plant, navigating through our menu. Don`t miss a chance to get a new source of greenery.',
};
